...
buttL = lexicalBundleList.button("Starting or Ending the Class", type = "secondary" if st.session_state["list_of_lex"].get("Opening and Disclosure") is None else "primary", use_container_width = True, on_click = show_button_description, args = ("Starting or Ending the Class", "An 'Starting or Ending the Class' statement signals the start or end of a discussion, presentation, or section, helping to structure the discourse by marking points of initiation or closure."))
buttM = lexicalBundleList.button("Quoting and Reporting", type = "secondary" if st.session_state["list_of_lex"].get("Citing Conversation") is None else "primary", use_container_width = True, on_click = show_button_description, args = ("Quoting and Reporting", "A 'Quoting and Reporting' statement recaps previous dialogues or comments, helping to reiterate and restructure established information within a conversation."))