...
st.set_page_config(layout="wide", page_title= "E.M.I.ghty", page_icon = ":scroll:")
...
buttB = lexicalBundleList.button("Expressing Necessity", type = "secondary" if st.session_state["list_of_lex"].get("Expressing Necessity") is None else "primary", use_container_width = True, on_click = show_button_description, args = ("Expressing Necessity", "An 'Expressing Necessity' contains phrases expressing a requirement or necessity, often directed at the second person pronoun, indicating actions deemed necessary or strongly recommended."))
...
buttK = lexicalBundleList.button("Place/Time/Text Reference", type = "secondary" if st.session_state["list_of_lex"].get("Place/Time/Text Reference") is None else "primary", use_container_width = True, on_click = show_button_description, args = ("Place/Time/Text Reference", "A 'Place/Time/Text Reference' statement indicates specific places, times, or locations within a text, providing clear references for context."))
buttL = lexicalBundleList.button("Starting or Ending the Class", type = "secondary" if st.session_state["list_of_lex"].get("Starting or Ending the Class") is None else "primary", use_container_width = True, on_click = show_button_description, args = ("Starting or Ending the Class", "An 'Starting or Ending the Class' statement signals the start or end of a discussion, presentation, or section, helping to structure the discourse by marking points of initiation or closure."))
buttM = lexicalBundleList.button("Quoting and Reporting", type = "secondary" if st.session_state["list_of_lex"].get("Quoting and Reporting") is None else "primary", use_container_width = True, on_click = show_button_description, args = ("Quoting and Reporting", "A 'Quoting and Reporting' statement recaps previous dialogues or comments, helping to reiterate and restructure established information within a conversation."))